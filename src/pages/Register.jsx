      ...
      <div className="auth-layout">
        <div className="auth-panel">
          ...
          <div className="form-group">
            ...
            <input type="text" placeholder="As on Aadhaar card" id="reg-name" />
          </div>
          ...
          <div className="form-group">
            ...
            <input type="password" placeholder="Min. 8 characters" id="reg-pass" />
          </div>
          <div className="form-group">
          ...
          <button className="btn btn-gold btn-full btn-lg" onClick={() => navigate('/otp')}>Continue to OTP <i className="ti ti-arrow-right"></i></button>
