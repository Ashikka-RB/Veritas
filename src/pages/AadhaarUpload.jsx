  ...
  return (
    <div className="page active" id="p-aadhaar">
      ...
      <div className="container-md pt-nav" style={{ paddingTop: '96px', paddingBottom: '60px' }}>
        ...
        {!uploaded ? (
          <div className="upload-zone" id="aadhaar-zone" onClick={simulateUpload}>
            <i className="ti ti-cloud-upload"></i>
            <div style={{ fontSize: '14px', color: 'var(--text2)', marginBottom: '4px' }}>Drag &amp; drop or click to upload</div>
            <div style={{ fontSize: '12px', color: 'var(--text3)' }}>JPG, PNG, PDF · Max 5 MB</div>
          </div>
        ) : (
